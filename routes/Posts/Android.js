...
app.set('views', path.join("C:\\Users\\HP\\Desktop\\Creative-Technology\\views", 'Android'));
...
router.post('/aupload', upload.single('Androidfile'), async (req, res) => {
  ...
  try {
    ...
    const filePath = path.join("C:\\Users\\HP\\Desktop\\Creative-Technology\\views\\", 'Android', fileName);
    const filecontent =
    `<!DOCTYPE html>
    <html>
    <head>
      ...
      <title>Android: Page(<%= PostPerPage %> out of <%= roundednumber%>) Creative Technology</title>
