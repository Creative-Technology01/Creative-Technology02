...
app.set('views', path.join("C:\\Users\\HP\\Desktop\\Creative-Technology\\views", 'Window'));
...
router.post('/wupload', upload.single('Windowfile'), async (req, res) => {
  ...
  try {
    ...
    const filePath = path.join("C:\\Users\\HP\\Desktop\\Creative-Technology\\views\\", 'Window', fileName);
    const filecontent =
    `<!DOCTYPE html>
      <html>
      <head>
        ...
        <title>Windows: Page(<%= PostPerPage %> out of <%= roundednumber%>) Creative Technology</title>
