...
app.set('views', path.join("C:\\Users\\HP\\Desktop\\Creative-Technology\\views", 'Gadgets'));
...
router.post('/gupload', upload.single('gadgetsfile'), async (req, res) => {
  ...
  try {
    ...
    const filePath = path.join("C:\\Users\\HP\\Desktop\\Creative-Technology\\views\\", 'Gadgets', fileName);
    const filecontent =
    `<!DOCTYPE html>
    <html>
    <head>
      ...
      <title>Gadgets: Page(<%= PostPerPage %> out of <%= roundednumber%>) Creative Technology</title>
